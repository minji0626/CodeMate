...
public class TboardModifyCommentAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		} else if (mem_num == db_tcomment.getMem_num()) { //로그인한 회원번호와 작성자 회원번호 일치
			TboardCommentVO tcomment = tdao.getTcomment(tc_num);
			tcomment.setTc_content(request.getParameter("tc_content"));
			
			tdao.modifyTcomment(tcomment);
