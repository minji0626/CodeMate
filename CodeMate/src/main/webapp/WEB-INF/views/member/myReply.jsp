...
<c:forEach var="comment" items="${commentList}">
    <div class="myPage-line-box" onclick="window.location.href='${pageContext.request.contextPath}/cboard/communityDetail.do?cb_num=${comment.cb_num}'">
    <div class="team-left-myWrite">
        ...
        <input type="submit" value="삭제" id="myDelete_btn" name="myDelete_btn" class="myDelete_btn" data-ccnum="${comment.cc_num}">
    </div>
    </div>
</c:forEach>
