...
<body>
	<div>
		...
		<div>
			...
			<ul>
				<li>
					<img src="${pageContext.request.contextPath}/images/cje/freeBoardIcon.png" width="30px" class="board-icon"> <span><a href="community.do">자유 게시판</a></span>
				</li>
				<li>
					<img src="${pageContext.request.contextPath}/images/cje/codingBoardIcon.png" width="30px" class="board-icon"> <span><a href="community2.do"><b>개발 게시판</b></a> </span>
				</li>
			</ul>
			</div>
		 <table>
